<<<<<<< HEAD
# 2 ბულეანის გამოყენება და and ოპერატორი
print(True and True)       # True
print(True and False)      # False
print(False and False)     # False

# 3 ბულეანის გამოყენება და and ოპერატორი
...
# 2 ბულეანის გამოყენება და or ოპერატორი
print(True or False)       # True
print(False or False)      # False
print(True or True)        # True

# 3 ბულეანის გამოყენება და or ოპერატორი
